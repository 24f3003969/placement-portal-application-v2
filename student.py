...
from application.models import (
    Application, StudentProfile, PlacementDrives, Interview, Placement, UserStatusHistory
)
...
class StudentProfileApi(Resource):
    ...
    def get(self):
        try:
            ...
            history_entries = UserStatusHistory.query.filter_by(user_id=current_user.id).order_by(UserStatusHistory.timestamp.desc()).all()
            status_history = []
